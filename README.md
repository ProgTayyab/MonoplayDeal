...
Apply data structures for managing game state
...
Data Structures (Vectors, Maps, Stacks, etc.)
...
Card distribution and management

Property, action, and money card handling
